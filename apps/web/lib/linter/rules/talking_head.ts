...
export const talkingHeadRules: RuleSet = {
  ...
  rules: [
    ...
    {
      id: 'th_hook_punchline_delayed',
      name: 'First Punchline Delayed',
      description: 'The first contrast, number, or conclusion appears after 1.5 seconds',
      severity: 'critical',
      category: 'hook',
      check: 'Does the first punchline, key number, or main point appear within the first 1.5 seconds?',
      goodExample: 'Lead with the punchline in the first sentence, push context to beat 2',
      badExample: 'Starting with background setup before revealing the main point',
    },
    {
